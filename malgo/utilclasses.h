...
namespace malgo 
{
	...
	template <class T, class A, class V> class compact_vector;
	template <class T, class A, class V> class uncompact_vector;
	template <typename V> struct vector_traits {};
	template <class T, class A, class V> struct vector_traits<compact_vector<T,A,V>> { using iterator = T*; using const_iterator = const T*; };

	struct row_order {};
	struct column_order {};

	template <class T, class O, class A, class M> struct matrix_keeper
	{
		A alloc;
	...
	template <class T, class O, class A, class M> class compact_matrix;
